...
class VariateTest < ActiveSupport::TestCase
  ...
  context 'A variate with a description' do
    setup do
      @variate = FactoryBot.create(:variate, description: 'A description')
    end
  ...
  context 'A variate with an interval measurement scale' do
    setup do
      @variate = FactoryBot.create(:variate, measurement_scale: 'interval')
    end
    ...
    context 'and belongs to a unit' do
      setup do
        @unit = FactoryBot.create(:unit, name: 'Good name')
        @variate.unit = @unit
      end
  ...
  context 'A variate with a ratio measurement scale' do
    setup do
      @variate = FactoryBot.create(:variate, measurement_scale: 'ratio')
    end
  ...
  context 'A variate with an ordinal measurement scale' do
    setup do
      @variate = FactoryBot.create(:variate, measurement_scale: 'ordinal')
    end
  ...
  context 'A variate with a nominal measurement scale' do
    setup do
      @variate = FactoryBot.create(:variate, measurement_scale: 'nominal')
    end
  ...
  context 'A variate with a date time measurement scale' do
    setup do
      @variate = FactoryBot.create(:variate, measurement_scale: 'dateTime')
    end
