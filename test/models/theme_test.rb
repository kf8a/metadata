...
class ThemeTest < ActiveSupport::TestCase
  ...
  context 'themes querying for datatables' do
    setup do
      ...
      @sub_theme = FactoryBot.create(:theme)
      @sub_sub_theme = FactoryBot.create(:theme)
    ...
    context 'datatables_in_study function' do
      context 'and a study with datatables' do
        setup do
          @datatable.theme = @theme
          assert @datatable.save
          @datatable2 = FactoryBot.create(:datatable, study: @study, theme: @theme)
          @outside_datatable = FactoryBot.create(:datatable, theme: @theme)
        end
