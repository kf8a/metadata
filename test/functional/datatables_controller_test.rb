...
class DatatablesControllerTest < ActionController::TestCase
  ...
  #   assert_equal datatable.errors.messages, {}
...
# #  end
  ...
  def test_caching_and_expiring
    ...
    @datatable = FactoryGirl.create :datatable, :dataset => FactoryGirl.create(:dataset), :description => 'This is the first abstract'
    get :show, :id => @datatable
